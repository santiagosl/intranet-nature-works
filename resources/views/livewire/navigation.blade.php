        ...
        <div class="flex h-16 items-center justify-between">
          <div class="flex items-center">
            ...
            <a href="/" class="flex-shrink-0">
              <img class="h-8 w-55" src="/storage/img/logo_nature_work.jpg" alt="Your Company">
            </a>
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="{{ route('pedidos.index') }}" class="bg-gray-900 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Pedidos</a>
      ...
      @auth
        <div class="md:hidden" id="mobile-menu" x-show="open" x-on:click.away="open=false">
          <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <a href="{{ route('pedidos.index') }}" class="bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium" aria-current="page">Pedidos</a>
          </div>
          ...
          <div class="border-t border-gray-700 pb-3 pt-4">
            ...
            <div class="mt-3 space-y-1 px-2">
              ...
              <form method="POST" action="{{ route('logout') }}" x-data>
                @csrf
                <a href="{{ route('logout') }}" class="block rounded-md px-3 py-2 text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white" role="menuitem" tabindex="-1" id="user-menu-item-2" @click.prevent="$root.submit();">Cerrar sesión</a>
              </form>
            </div>
          </div>
        @else
